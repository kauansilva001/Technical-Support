...
<main style="display:flex; justify-content:center;">
        <form action="controler.php" method="POST">
            ...
            <label>Usuário:</label>
            <div class="division-grid"><div class="division-icon"><i class='bx bx-user'></i></div><input class="input-style" type="email"></div> <!--Lembrar de colocar o nome para o uso do PHP--> </tr>
